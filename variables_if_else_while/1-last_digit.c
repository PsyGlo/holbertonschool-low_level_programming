...
 *
 * Description: This program assigns a random number to n using rand(),
 * extracts the last digit using modulo, and prints whether it is greater
 * than 5, equal to 0, or less than 6 and not 0. The output format is:
 * "Last digit of [n] is [last_digit] and is [condition]".
 *
